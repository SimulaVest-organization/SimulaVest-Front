    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      ...
      >
        ...
        <button
          ...
          className="w-15 h-15 bg-white rounded-md flex items-center justify-center shadow-sm hover:shadow-md transition-shadow"
        >
        ...
        <button
          ...
          className="w-15 h-15 bg-white rounded-md flex items-center justify-center shadow-sm hover:shadow-md transition-shadow"
        >
          <svg width="30" height="25" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
